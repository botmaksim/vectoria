...
export const translations = {
    en: {
        ...
        tutorial_text: 'Notes & Markdown: Append text blocks housing Markdown to annotate workspaces and document your projects.',
    ...
    ru: {
        ...
        tutorial_text: 'Заметки и Аннотации: Создавайте текстовые блоки в формате Markdown для документирования графиков и описания рабочих областей.',
